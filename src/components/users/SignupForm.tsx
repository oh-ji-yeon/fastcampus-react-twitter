...
export default function SignupForm() {
    ...
    return (
        <form className="form form--lg" onSubmit={onSubmit}>
            ...
            <div className="form__block">
                <label htmlFor="password_confirmation">password check</label>
            ...
            <div className="form__block">
                <button type="button" name="google" className="form__btn--google" onClick={onClickSocialLogin}>Google로 회원가입</button>
            </div>
            <div className="form__block">
                <button type="button" name="github" className="form__btn--github" onClick={onClickSocialLogin}>GitHub으로 회원가입</button>
            </div>
        </form>
    );
}